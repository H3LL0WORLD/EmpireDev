...
class Module:
    ...
    def __init__(self, mainMenu, params=[]):
        ...
        self.info = {
            ...
            'Description': ('Get the UAC notification level'),
    ...
    def generate(self):
        ...
        # script += """
        script = """
function Get-UACNotificationLevel {
    $Path = 'HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\System'

    Switch ([String]((Get-ItemProperty -Path $Path).ConsentPromptBehaviorAdmin, (Get-ItemProperty -Path $Path).PromprOnSecureDesktop)) {
       '0 0' {return 'UAC Level 0: No notificar nunca}
       '5 0' {return 'UAC Level 1: Notificar cuando una aplicacion intente hacer cambios en el equipo (Sin atenuar el escritorio)'}
       '5 1' {return 'UAC Level 2: Notificar cuando una aplicacion intente hacer cambios en el equipo'}
       '2 1' {return 'UAC Level 3: Notificar siempre'}
    }
}
Get-UACNotificationLevel
"""
