...
class Module:
    ...
    def __init__(self, mainMenu, params=[]):
        ...
        self.info = {
            ...
            'Name': 'Set UAC notification level',

            # List of one or more authors for the module
            'Author': ['@H3LL0WORLD'],

            # More verbose multi-line description of the module
            'Description': ('Set the UAC notification level by changing some keys in the registry'),
    ...
    def generate(self):
        ...
        moduleSource = self.mainMenu.installPath + "/data/module_source/collection/set_uac_level.ps1"
        try:
        ...
        #
        script += """Set-UACNotificationLevel"""
